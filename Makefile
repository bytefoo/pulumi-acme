...
prepare::
	...
	if [[ "${OS}" != "Darwin" ]]; then \
		sed -i 's,github.com/bytefoo/pulumi-acme,${REPOSITORY},g' provider/go.mod; \
...
build_sdks:: install_plugins provider  build_go build_dotnet # build all the sdks
